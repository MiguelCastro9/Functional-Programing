...
public class Streams {
    ...
    public static void main(String[] args) {
        ...
        lista.stream()
                ...
                .filter(e -> e % 2 == 0)
                // transformando dados, lembrando que este método não modifica os dados da lista original.
                .map(e -> e * 2)
        ...
        Optional<Integer> listaReduce = lista.stream()
                ...
                // neste caso ele faz a soma de todos os elementos para trasformar em um único elemento.
                .reduce((n1, n2) -> n1 + n2);
